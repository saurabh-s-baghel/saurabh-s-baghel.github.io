...
const Navbar = () => {
  ...
  return (
    <nav
      ...
      isScrolled ? 'bg-[#0B0B0E]/80 backdrop-transparent-xl border-b border-yellow-400/20 shadow-lg shadow-red-600/80': 'bg-transparent'
      }`}
    >
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-black/98 border-t border-red-900/20">
          <div className="px-6 py-4 space-y-4">
            ...
            <Button
              onClick={() => scrollToSection('contact')}
              className="w-full bg-gradient-to-r from-red-600 to-yellow-400 hover:from-red-700 hover:to-yellow-400 text-white"
            >
              Get in Touch
            </Button>
          </div>
